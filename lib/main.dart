...
class _FadingTextPageState extends State<FadingTextPage>
  ...
  // Start/stop repeated fade in/out, then reset to full opacity when stopping.
  void toggleAnimation() {
    if (_isAnimating) {
      // Stop and reset to fully visible
      _controller.stop();
      _controller.value = 1.0; // ensures text is fully opaque
      _isAnimating = false;
    } else {
      // Start repeated fade
